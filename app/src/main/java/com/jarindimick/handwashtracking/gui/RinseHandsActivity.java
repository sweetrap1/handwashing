...
public class RinseHandsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (videoStepView != null) {
            String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.rinse_hands_instruction_video;
            ...
            videoStepView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                ...
                public void onPrepared(MediaPlayer mp) {
                    ...
                    if (mp.getDuration() > 0 && mp.getDuration() < STEP_DURATION_MS) {
                        mp.setLooping(true);
                        Log.d("RinseHandsActivity", "Video shorter, enabling loop. Duration: " + mp.getDuration() + "ms");
                    } else {
                        mp.setLooping(false);
                        Log.d("RinseHandsActivity", "Video not looping. Duration: " + mp.getDuration() + "ms");
                    }
                }
            });
            ...
            videoStepView.setOnErrorListener(new MediaPlayer.OnErrorListener() {
                ...
                public boolean onError(MediaPlayer mp, int what, int extra) {
                    Log.e("RinseHandsActivity", "VideoView Error: what=" + what + ", extra=" + extra);
                    return true;
                }
            });
        }
    ...
    protected void onDestroy() {
        ...
        Log.d("RinseHandsActivity", "onDestroy called, timers cancelled, video stopped."); //
    }
}